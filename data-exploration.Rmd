...
## def #1:
(prop.house.race - prop.race.ff) / prop.race.ff
(prop.house.raceeth - prop.raceeth.ff) / prop.raceeth.ff
(prop.house.span[1] - prop.hisp.ff) / prop.hisp.ff

## def #2
(prop.hh.race - prop.race.ff) / prop.race.ff
(prop.hh.raceeth - prop.raceeth.ff) / prop.raceeth.ff
(prop.hh.span[1] - prop.hisp.ff) / prop.hisp.ff
```
...
# Calculate % difference
## by #1:
(tenure.byhousingrace[,2:3] - tenure.ff) / tenure.ff
(tenure.byhousingspan[1,2:3] - tenure.span.ff) / tenure.span.ff

## by #2:
(tenure.byhhrace[,2:3] - tenure.ff) / tenure.ff
(tenure.byhhspan[1,2:3] - tenure.span.ff) / tenure.span.ff
```
