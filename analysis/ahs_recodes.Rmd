...
ahs_flat <- read.csv("raw data/ahs2017_hhsubset_flat.csv", as.is=TRUE)
```
...
recode.hhmar <- c("'1'" = "Married, spouse present",
                  ...
                  "'-6'" = NA)
ahs_flat <- ahs_flat %>%
  mutate(HHGRAD = ifelse(HHGRAD %in% c("'31'","'32'", "'33'", "'34'"), "1_< HS",
...
ahs_flat$HHGRAD <- revalue(ahs_flat$HHGRAD, recode.hhgrad)
ahs_flat$HHGRAD <- as.factor(ahs_flat$HHGRAD)
